 ...
 * @author SCC-COLLEGE
 */
public class applyAssistance extends javax.swing.JFrame {

    /**
     * Creates new form admin_dashboard
     */
    public applyAssistance() {
        initComponents();
        displayApplication();
    }
    ...
    private void initComponents() {
        ...
        jLabel22.setText("Delete Application");
        ...
        jPanel4.add(dash3, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 140, -1, -1));
        ...
        jLabel23.setText("Apply Program");
        ...
        jLabel24.setText("View Application");
    ...
    int rowindex = tblapplication.getSelectedRow();
        if(rowindex < 0){
            ...
            int confirm = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this application?", "Confirm Deletion", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                dbConnector dbc = new dbConnector();
                TableModel model = tblapplication.getModel();
                String id = model.getValueAt(rowindex, 0).toString();
                dbc.updateData("DELETE FROM tbl_applicant WHERE app_id = '" + id + "'");
                Session sess = Session.getInstance();
                dbc.logActivity2(sess.getUid(), "Deleted application ID: " + id);
                displayApplication();
    ...
    applyProgram ap = new applyProgram();
    ap.setVisible(true);
    this.dispose();
    ...
    int rowIndex = tblapplication.getSelectedRow();
        if(rowIndex < 0){
            ...
            try{
                ...
                ResultSet rst = dbc.getData("SELECT * FROM tbl_applicant WHERE app_id = '"+tbl.getValueAt(rowIndex, 0)+"'");
                if(rst.next()){
                    viewApplication vap = new viewApplication();
                    ...
                    vap.image.setIcon(vap.ResizeImage(rst.getString("app_docs"), null, vap.image));
                    vap.oldpath = rst.getString("app_docs");
                    vap.path = rst.getString("app_docs");
                    vap.destination = rst.getString("app_docs");
                    vap.setVisible(true);
                    this.dispose();
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(applyAssistance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new applyAssistance().setVisible(true);
            }
        });
    }
