...
public class SecurityQ extends javax.swing.JFrame {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
       ...
       if(sess.getUid() == 0){
            JOptionPane.showMessageDialog(this, "Cannot open this form, login first!", "Error", JOptionPane.ERROR_MESSAGE);
        }else{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (question.isEmpty() || question.isEmpty()){
            ...
            try {
            String answer = passHash.hashPassword(ans.getText());
            dbConnector dbc = new dbConnector();
            dbc.updateData("UPDATE tbl_user SET question = '" + question + "', answer = '"+answer+"' WHERE u_id = '" +uid.getText()+ "'");
