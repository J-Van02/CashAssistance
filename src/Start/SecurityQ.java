...
import static Start.loginform.loginAcc;
import static Start.loginform.status;
...
public class SecurityQ extends javax.swing.JFrame {
    ...
    public static boolean loginAcc(String email, String password){
        ...
        try{
            ...
            if(resultSet.next()){
                String hashedPass = resultSet.getString("answer");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(loginAcc(un.getText(), ans.getText())){
